...
def run():
    with sync_playwright() as p:
        ...
        # Log out variables right before setting innerHTML
        page.evaluate("""
            ...
            Object.defineProperty(document.getElementById("passenger-eta-list"), 'innerHTML', {
                set: function(val) {
                    console.log("Setting ETA list HTML. If empty, check caller");
                    try { throw new Error('trace'); } catch(e) { console.log(e.stack.split('\\n')[2]); }
