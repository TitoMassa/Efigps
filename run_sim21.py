...
def run():
    with sync_playwright() as p:
        ...
        page.evaluate("""
            window.debugETAs = function() {
                ...
                if (lineVal.startsWith("sim_")) {
                    ...
                    if (devResult) {
                        ...
                        console.log("ETA DISPLAY:", etaDisplay);
                    } else {
            ...
            // Wait, we need to load RouteLogic script into context if it's not global?
            // It IS global because of `<script src="js/route_logic.js"></script>`
        """)
