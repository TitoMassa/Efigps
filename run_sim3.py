...
def run():
    with sync_playwright() as p:
        ...
        print("Debugging updatePassengerETAs for Stop 2")
        # We can intercept or overwrite updatePassengerETAs to console.log internal state
        page.evaluate("""
            const oldUpdate = updatePassengerETAs;
            updatePassengerETAs = function() {
                ...
                console.log("updatePassengerETAs called with stop=", stopIndexStr, "route=", routeVal, "line=", lineVal);
                oldUpdate();
                console.log("etaList HTML:", els.passengerEtaList.innerHTML);
            };
        """)
