...
def run():
    with sync_playwright() as p:
        ...
        # Add a global script into app.js execution context
        page.evaluate("""
            window.testCallUpdate = () => {
        ...
        page.evaluate("window.testCallUpdate()")
        time.sleep(1)
        ...
        page.evaluate("""
            ...
            const simulatedDriver = state.simulatedDrivers[0];
            console.log("simulated driver state:", simulatedDriver);
            console.log("ETA LIST AFTER SELECT STOP 2:", document.getElementById('passenger-eta-list').innerHTML);
        """)
