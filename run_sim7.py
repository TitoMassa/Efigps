...
def run():
    with sync_playwright() as p:
        ...
        page.evaluate("""
            const originalUpdatePassengerETAs = updatePassengerETAs;
            updatePassengerETAs = function() {
                console.log("Called updatePassengerETAs");
                try {
                    ...
                    console.log("Values:", {stopIndexStr, routeVal, lineVal});
                    ...
                    if (lineVal.startsWith("sim_")) {
                        ...
                        console.log("Parts:", parts, "TripIndex:", tripIndex);

                        if (driver.lat === null || driver.lng === null) {
                            console.log("Driver lat lng is null");
                        }
                    }

                    originalUpdatePassengerETAs();
                    console.log("ETA LIST HTML AFTER:", els.passengerEtaList.innerHTML);
                } catch(e) {
                    console.error("ERROR in updatePassengerETAs:", e);
                }
            }
        """)
